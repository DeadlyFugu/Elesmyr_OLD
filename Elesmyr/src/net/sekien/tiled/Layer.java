 ...
 * @param lineByLine
 * 		True if we should render line by line, i.e. giving us a chance to render something else between lines
 * @param mapTileWidth
...
/**
 * Gets all Tiles from this layer, formatted into Tile objects Can only be used if the layer was loaded using
 * TiledMapPlus
 *
 * @throws SlickException
 */
...
/**
 * Get all tiles from this layer that are part of a tileset Can only be used if the layer was loaded using TiledMapPlus
 *
 * @param tilesetName
...
/**
 * Sets a tile's tileSet Can only be used if the layer was loaded using TiledMapPlus
 *
 * @param x
 * 		Tile X
 * @param y
 * 		Tile Y
 * @param tileOffset
 * 		The offset of the tile, within the tileSet to set this tile to, ordered in rows
 * @param tilesetName
...
/**
 * Returns true if this tile is part of that tileset Can only be used if the layer was loaded using TiledMapPlus
 *
 * @param x
